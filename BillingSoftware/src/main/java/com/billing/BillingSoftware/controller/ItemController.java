...
public class ItemController {
    ...
    public ItemResponse addItem(@RequestPart("item") String itemString, @RequestPart("file") MultipartFile file) {
        ...
        try {
            ...
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Error occurred while trying to add the item");
        }
    }
    ...
    public void removeItem(@PathVariable String itemId) {
        try{
            ...
            throw new ResponseStatusException(HttpStatus.NOT_FOUND, "Unable to delete the item");
        }
    }
}
